...
public class TextureTilingController : MonoBehaviour {
	...
	void UpdateTiling()
	{
		...
		gameObject.renderer.material.SetTextureScale("_BumpMap", new Vector2(planeSizeX*gameObject.transform.lossyScale.x/textureToMeshX, planeSizeZ*gameObject.transform.lossyScale.z/textureToMeshZ));
	}
}